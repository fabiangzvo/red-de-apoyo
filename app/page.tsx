      ...
      <main className="flex-1">
          ...
          <div className="mx-auto grid max-w-6xl gap-10 px-4 py-16 md:grid-cols-[1.1fr_0.9fr] md:py-24">
            <div className="flex flex-col justify-center">
              ...
              <h1 className="text-balance font-display text-4xl font-bold leading-[1.05] tracking-tight md:text-6xl">
                Ayuda humanitaria directa, ítem por ítem.
              </h1>
              <p className="mt-5 max-w-xl text-pretty text-lg leading-relaxed text-muted-foreground">
                ...
                por partes, sin intermediarios.
              </p>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                <Button size="lg" className="h-11 px-5 text-base" render={<Link href="/solicitar" />}>
        ...
        <section className="mx-auto max-w-6xl px-4 py-16">
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2">
            <PathCard
              ...
              cta={{ href: "/solicitar", label: "Crear mi lista", Icon: PlusCircle }}
            />
            <PathCard
              tone="muted"
        ...
        <section className="border-t border-border bg-card/40">
          <div className="mx-auto max-w-6xl px-4 py-16">
            <h2 className="text-balance font-display text-2xl font-bold tracking-tight md:text-3xl">
              Sistema de reserva por ítems
            </h2>
            <p className="mt-3 max-w-2xl text-pretty leading-relaxed text-muted-foreground">
              Cada necesidad tiene su propio estado. Así nadie duplica esfuerzos y
              las familias ven en tiempo real qué falta por atender.
            </p>
      ...
      <footer className="border-t border-border">
        <div className="mx-auto flex max-w-6xl flex-col items-center justify-between gap-3 px-4 py-8 text-sm text-muted-foreground sm:flex-row">
          ...
          <p className="text-pretty text-center sm:text-right">
            Plataforma comunitaria sin ánimo de lucro. Ayuda directa, sin
            intermediarios.
          </p>
        </div>
      </footer>
...
function StatCell({
  ...
  return (
    <div className="rounded-lg border border-border bg-background p-3">
      <Icon className={`mx-auto size-4 ${tone}`} aria-hidden />
